...
import img10 from '../img/IMG_5528.JPG'
  ...
  return (
    <section className='py-2'>
      ...
      <div className='container px-4 px-lg-5 my-5'>
        <div id='detailWrap' className='row gx-4 align-items-center'>
          <div className='col-md-6'>
            <img className='card-img-top' src={img10} alt='Mexrop' />
          </div>
          <div className='col-md-6'>
            <div className='small mb-1'></div>
            <h1 className='display-5 fw-bolder'>Мехроп</h1>
            <div className='fs-5'>
              <span>32.000 сум</span>
              <span></span>
            </div>
            <p className='lead'>
